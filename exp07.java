...
/*
    ...
    DONT TRY CONTROL TEST YOU WONT BE FINDING THE FILES
 */
...
public class DAALabExp07 {
    ...
    private static void manualArray() {
        int[] array = new int[] {6,3,7,2,4,5, Integer.MAX_VALUE};

        QuickSort init = new QuickSort();
        System.out.println(Arrays.toString(array));
        init.initSort(array, 0, array.length - 1);
        if(check(array)) {
